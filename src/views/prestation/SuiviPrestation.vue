<template>
  <div class="loan-timeline">
    ...
    <h1 class="title">Suivi de votre prestation</h1>
    <!-- {{pretEncours}} -->
    <div class="timeline-container">
      ...
      <div class="timeline-step accepted">
        ...
        <div class="step-content">
          ...
          <h3>Président</h3>
          <p>Votre demande de prêt a été validée</p>
          <div class="step-date">15 juin 2023</div>
        </div>
      </div>
      ...
      <div class="timeline-step current">
        ...
        <div class="step-content">
          ...
          <h3>Daouda</h3>
          <p>Transfert des fonds vers votre compte</p>
          <div class="step-date">En traitement</div>
        </div>
      </div>
      ...
      <div class="timeline-step pending">
        ...
        <div class="step-content">
          ...
          <div class="step-date">À venir</div>
        </div>
      </div>
    </div>
  </div>
...
const pretEncours = computed(() => {
  let data = pretStore.getterPret.find(item => item.encours === 1);
  if (data) {
    return data;
  }
  return [];
